...
const NotAuthorizedMenu = () => {
    ...
    return (
        <ul>
            <li className="current_page_item parent-list">
                <a href="index.html">Home <span className="menu-nav-arrow"><i className="icon-angle-down"/></span></a>
            ...
            <li className="parent-list"><a href="cat_question.html">Questions <span
                className="menu-nav-arrow"><i className="icon-angle-down"/></span></a>
                <ul style={{ display: 'none' }}>
            ...
            <li className="parent-list"><a href="blog_1.html">Blog <span className="menu-nav-arrow"><i
                className="icon-angle-down"/></span></a>
                <ul style={{ display: 'none' }}>
